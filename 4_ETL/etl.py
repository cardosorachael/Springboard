...
tmp_trade_df = spark.sql("select trade_dt, symbol, exchange, event_tm, event_seq_nb, trade_price from trades where trade_dt = '2020-08-06'")
...
mov_avg_df = spark.sql("""
    ...
    AVG(trade_price) OVER (PARTITION BY (symbol)
...
quote_final.write.parquet("path_new/trade_dt={}".format(trade_date))
